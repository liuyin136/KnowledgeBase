...
env_key = "OPENAI_API_KEY"                # Environment variable holding the API key (optional)
...
2. The environment variable named by `env_key` (used only if that variable is actually set)
